...
<div class="container">
  ...
  <form action="../model/add_store_loc.php" method='post'>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="StoreName" value="" class="form-control" required
                      pattern="[A-Z][a-z]*((-|\s)[A-Z][a-z]*)*" title="Example: Store, Store-Name, Store Name, Store-Name-Long"/>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" title="Phone must be in the format: XXX-XXX-XXXX"/>
                  </div>
