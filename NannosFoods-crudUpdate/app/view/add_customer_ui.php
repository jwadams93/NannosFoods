...
<div class="container container shadow p-4 mb-5 mt-5 bg-white rounded">
  ...
  <form action="../model/add_customer.php" method='post'>
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="Name" value="" class="form-control" required pattern="^[A-Z][a-z]*|[A-Z][a-z]*((-|\s)[A-Z][a-z]*)*" title="Name Invalid: Names must begin with a capital: John, John-Brown, John Peters"/>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label>Phone</label>
                    <input type="text" name="Phone" value="" class="form-control" required pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" title="Invalid Phone: Must be in format XXX-XXX-XXXX"/>
                </div>
            </div>
