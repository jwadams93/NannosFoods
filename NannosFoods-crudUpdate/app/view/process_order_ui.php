...
<head>
  ...
  <title>Create An Order | Nanno's Food</title>
...
<form action="process_order_ui.php" method="POST">
...
<div class="container" id="items">
  <div class="row" style="display: inline;">
      <h3 class="font-weight-light">Items to Order</h3>
...
<form action="../model/process_order.php" method="POST" id="fullItemForm">
  <div class="container">
